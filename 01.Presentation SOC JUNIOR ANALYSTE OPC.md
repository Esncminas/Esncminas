 ...
 **[Voir le repository complet du projet : Déploiement d'un SIEM](https://github.com/Esncminas/Esncminas/blob/main/Projet11.md))**
...
--> "Parsing d'entêtes complexes , typage MIME, enrichissement IoC."<br> 
Programmation Python & API REST,███████░░░ 70%,<br> 
--> "Scripting , requêtes HTTP synchrones (Webhooks), sérialisation et parsing JSON."<br> 
...
<mark>Troubleshooting</mark> : Interprétation des codes d'erreurs serveur et échanges sur des forums spécialisés .<br>
<mark>Standardisation</mark> : Nommage systématisé des variables et structuration des flux JSON selon les conventions de la scène tech internationale.<br>
